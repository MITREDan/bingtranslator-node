...
function getLanguagesForSpeak(credentials, httpOptions, cb) {
  var options = {
    hostname: 'api.microsofttranslator.com',
    port: 80,
    path: '/v2/Ajax.svc/GetLanguagesForSpeak',
    method: 'GET'
  };

  // incorporate user's http options into http options object
  for (var attrname in httpOptions) { options[attrname] = httpOptions[attrname]; }
...
module.exports = getLanguagesForSpeak;
